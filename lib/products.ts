...
export const products: Product[] = [
  // Home Gadgets
  {
    ...
    affiliateUrl: "https://www.amazon.com/s?k=smart+led+desk+lamp&tag=YOURTAG-20",
  ...
  },
  {
    ...
    affiliateUrl: "https://www.amazon.com/s?k=mini+projector+portable&tag=YOURTAG-20",
    category: "home-gadgets",
    badge: "Top Pick",
  },
  {
    ...
    affiliateUrl: "https://www.amazon.com/s?k=robot+vacuum+cleaner&tag=YOURTAG-20",
    category: "home-gadgets",
  },
  {
    id: "hg-4",
    ...
    affiliateUrl: "https://www.amazon.com/s?k=smart+plug+4+pack&tag=YOURTAG-20",
    category: "home-gadgets",
  },
  // Outdoor
  {
    ...
    affiliateUrl: "https://www.amazon.com/s?k=ultralight+camping+hammock&tag=YOURTAG-20",
    category: "outdoor",
    badge: "Staff Pick",
  },
  {
    ...
    affiliateUrl: "https://www.amazon.com/s?k=portable+solar+charger+power+bank&tag=YOURTAG-20",
    category: "outdoor",
    badge: "Best Seller",
  },
  {
    ...
    affiliateUrl: "https://www.amazon.com/s?k=lightweight+trekking+poles&tag=YOURTAG-20",
    category: "outdoor",
  },
  {
    id: "out-4",
    ...
    affiliateUrl: "https://www.amazon.com/s?k=waterproof+dry+bag+20l&tag=YOURTAG-20",
    category: "outdoor",
  },
  // Home Decor
  {
    ...
    affiliateUrl: "https://www.amazon.com/s?k=boho+macrame+wall+hanging&tag=YOURTAG-20",
    category: "home-decor",
    badge: "Trending",
  },
  {
    ...
    affiliateUrl: "https://www.amazon.com/s?k=minimalist+floating+shelves+set&tag=YOURTAG-20",
    category: "home-decor",
  },
  {
    id: "dec-3",
    ...
    affiliateUrl: "https://www.amazon.com/s?k=faux+pampas+grass+decor&tag=YOURTAG-20",
    category: "home-decor",
    badge: "Trending",
  },
  {
    ...
    affiliateUrl: "https://www.amazon.com/s?k=woven+seagrass+storage+baskets&tag=YOURTAG-20",
    category: "home-decor",
  },
  // Kitchen
  {
    ...
    price: "$17.99",
    image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=80",
    affiliateUrl: "https://www.amazon.com/s?k=digital+kitchen+scale+stainless&tag=YOURTAG-20",
    category: "kitchen",
    badge: "Best Seller",
  },
  {
    ...
    affiliateUrl: "https://www.amazon.com/s?k=silicone+cooking+utensil+set&tag=YOURTAG-20",
    category: "kitchen",
  },
  {
    id: "kit-3",
    ...
    affiliateUrl: "https://www.amazon.com/s?k=cold+brew+coffee+maker+glass&tag=YOURTAG-20",
    category: "kitchen",
    badge: "Top Pick",
  },
  {
    ...
    affiliateUrl: "https://www.amazon.com/s?k=bamboo+cutting+board+set&tag=YOURTAG-20",
    category: "kitchen",
  },
  // Man Cave
  {
    ...
    affiliateUrl: "https://www.amazon.com/s?k=led+strip+lights+rgb+app+controlled&tag=YOURTAG-20",
    category: "man-cave",
    badge: "Best Seller",
  },
  {
    ...
    affiliateUrl: "https://www.amazon.com/s?k=gaming+chair+lumbar+support+ergonomic&tag=YOURTAG-20",
    category: "man-cave",
    badge: "Top Pick",
  },
  {
    ...
    affiliateUrl: "https://www.amazon.com/s?k=wireless+gaming+headset+surround+sound&tag=YOURTAG-20",
    category: "man-cave",
  },
  {
    id: "mc-4",
    ...
    price: "$44.99",
    image: "https://images.unsplash.com/photo-1584568694244-14fbdf83bd30?w=400&q=80",
    affiliateUrl: "https://www.amazon.com/s?k=mini+fridge+compact+desk+garage&tag=YOURTAG-20",
    category: "man-cave",
    badge: "Staff Pick",
  },
  {
    ...
    affiliateUrl: "https://www.amazon.com/s?k=pegboard+tool+organizer+garage+kit&tag=YOURTAG-20",
    category: "man-cave",
  },
  {
    id: "mc-6",
    ...
    affiliateUrl: "https://www.amazon.com/s?k=mechanical+gaming+keyboard+rgb+tenkeyless&tag=YOURTAG-20",
    category: "man-cave",
  },
  {
    id: "mc-7",
    ...
    affiliateUrl: "https://www.amazon.com/s?k=dart+board+cabinet+set+sisal&tag=YOURTAG-20",
    category: "man-cave",
  },
  {
    id: "mc-8",
    ...
    price: "$67.99",
    image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=80",
    affiliateUrl: "https://www.amazon.com/s?k=heavy+duty+garage+shelving+unit+steel&tag=YOURTAG-20",
    category: "man-cave",
    badge: "Best Seller",
  },
];
